...
export default defineConfig(({ mode }) => {
    ...
    // Base path for deployment - defaults to "/" but can be overridden via VITE_BASE_PATH env var
    // For subdirectory deployments like "/in-memoriam-pascal/", set VITE_BASE_PATH=/in-memoriam-pascal/
            ...
            VitePWA({
                ...
                manifest: {
                    ...
                    icons: [
                        ...
                        {
                            src: `${basePath}icons/maskable-icon.png`,
                            sizes: '512x512',
                            type: 'image/png',
                            purpose: 'maskable',
                        },
